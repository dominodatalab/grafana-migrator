...
def test_uid_match_wins_over_no_match():
    index = DashboardIndex(
        [ExistingDashboard(cr_name="my-grafana-elasticsearch", namespace="ns", uid="ElasticSearch", title="ElasticSearch")]
    )
...
def test_contact_point_index_matches_by_normalized_name():
    index = ContactPointIndex([ExistingContactPoint(cr_name="migrated-platform-slack", namespace="ns", name="Platform Slack")])
